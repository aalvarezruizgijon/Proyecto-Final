...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb" style="font-size:0.85rem">
        <li class="breadcrumb-item"><a href="/Proyecto/Controller/admin/vehiculos.php">Vehículos</a></li>
...
<div class="admin-table-card p-4" style="max-width:800px">
    <form method="POST" action="/Proyecto/Controller/admin/vehiculo_form.php" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            ...
            <div class="col-12 d-flex gap-2 mt-3 pt-3 border-top">
                ...
                <a href="/Proyecto/Controller/admin/vehiculos.php" class="btn btn-outline-secondary">
                    Cancelar
                </a>
            </div>
        </div>
