...
<head>
    ...
    <link rel="stylesheet" href="/Proyecto/View/admin/css/admin.css">
    <link rel="shortcut icon" href="/Proyecto/View/img/logo.png" type="image/x-icon">
</head>
<body>
<div class="admin-wrapper">
    ...
    <aside class="admin-sidebar">
        ...
        <div class="admin-sidebar-footer">
            <a href="/Proyecto/Controller/index.php" class="back-link">
                <i class="bi bi-arrow-left-circle"></i> Volver a la web
            </a>
            <a href="/Proyecto/Controller/logout.php">
