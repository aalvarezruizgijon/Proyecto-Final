...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb" style="font-size:0.85rem">
        <li class="breadcrumb-item"><a href="/Proyecto/Controller/admin/clientes_admin.php">Clientes</a></li>
                    ...
                    <?php foreach ($reservas as $r): ?>
                        ...
                        <tr class="collapse" id="sancion-<?= $r->getId() ?>">
                            <td colspan="10" class="bg-light">
                                <form method="POST" action="/Proyecto/Controller/admin/cliente_detalle.php?id=<?= $cliente->getId() ?>"
