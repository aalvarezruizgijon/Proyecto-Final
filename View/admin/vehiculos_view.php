...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="/Proyecto/Controller/admin/vehiculo_form.php" class="btn btn-primary px-4"
            ...
            <tbody>
                <?php foreach ($coches as $coche): ?>
                    <tr data-disponible="<?= $coche->getDisponible() ? 'si' : 'no' ?>"
                        ...
                        <td>
                            <form method="POST" action="/Proyecto/Controller/admin/vehiculos.php" style="display:inline">
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="/Proyecto/Controller/admin/vehiculo_form.php?id=<?= $coche->getId() ?>"
                                   class="btn btn-sm btn-outline-primary" title="Editar">
                                    <i class="bi bi-pencil-fill"></i>
                                </a>
                                <form method="POST" action="/Proyecto/Controller/admin/vehiculos.php"
