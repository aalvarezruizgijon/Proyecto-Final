            ...
            <div class="card card-detalle shadow-lg">
                <div class="reserva-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div>
                        ...
                        <p class="mb-0 opacity-75">Gestiona y actualiza los días de tu alquiler</p>
                    </div>
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-7">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-6">
                                        <label class="info-label mb-2 d-block">Fecha de Devolución</label>
                                        <input type="date" name="nueva_fecha_fin" id="edit_fecha_fin" 
                                               class="form-control rounded-custom border-2" 
